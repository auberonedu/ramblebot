...
class LowercaseSentenceTokenizerTest {
    ...
    // Wave 3
    @Test
    void testTokenizeWithInternalPeriods() {
        LowercaseSentenceTokenizer tokenizer = new LowercaseSentenceTokenizer();
        Scanner scanner = new Scanner("This is Dr.Smith's example.");
        List<String> tokens = tokenizer.tokenize(scanner);

        assertEquals(List.of("this", "is", "dr.smith's", "example", "."), tokens);
    }
